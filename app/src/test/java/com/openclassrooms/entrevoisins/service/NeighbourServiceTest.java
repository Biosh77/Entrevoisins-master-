...
public class NeighbourServiceTest {
    ...
    public void changeFavoriteNeighbourWithSuccess() {
        ...
        service.changeFavoriteNeighbour(neighbourToChange.getId());
        assert (service.getFavoriteNeighbours().contains(neighbourToChange));
    }
    ...
    public void getFavoriteNeighboursWithSuccess() {
        ...
        for (int i = 0; i < favoriteNeighbours.size(); i++) {
            assert favoriteNeighbours.get(i).getIsFavorite();
        }
    }
}
